...
function writeOrderArrayOnTable() {
   ...
   for (var i = 0; i < orderArray.length; i = i + 1) {
      ...
      table = table + "<td>" + orderArray[i].milkOption + "</td></tr>";
   }
